...
int key_weapon7 = '7';
int key_weapon8 = '8';
int key_prevweapon = KEYP_MINUS;
int key_nextweapon = KEYP_PLUS;
...
int key_menu_confirm   = KEY_RIGHTARROW;
int key_menu_abort     = KEY_LEFTARROW;
...
int key_menu_incscreen = 0;
int key_menu_decscreen = 0;
